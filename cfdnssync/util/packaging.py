...
from cfdnssync.util.execx import execx
...
def pip_installed(name: str):
    ...
    return next((package for package in inspect["installed"] if package["metadata"]["name"] == name), None)
...
def program_name():
    ...
    - pipx: cloudflareupdater
    - pipx for pr 1000: cloudflareupdater@1000
    """
